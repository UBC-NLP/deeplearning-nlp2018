...
| Wed Sept 26    |    Machine Learning Basics II; Word meaning |  [[JM CH06: Vector Semantics](https://web.stanford.edu/~jurafsky/slp3/6.pdf)] |           |
| Mon Oct 1    |    Language Models; Feedforward Networks |  [[A neural probabilistic language model](http://www.cs.ubc.ca/~amuham01/LING530/papers/bengio2003neural.pdf)]; [[DLB CH06](https://www.deeplearningbook.org/contents/mlp.html)] |           |
