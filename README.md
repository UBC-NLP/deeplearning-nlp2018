...
| Mon Sept 10    |  Guest speaker (MAM@ECML) / Emilie Francis (SFU) | Misinformation; Linear Algebra I: [[DLB CH02](https://www.deeplearningbook.org/contents/linear_algebra.html); [MIT Course](https://www.youtube.com/watch?v=ZK3O402wf1c&list=PLE7DDD91010BC51F8)]  |    hw01 out (Canvas)        |
| Wed Sept 12    |  Guest speaker (MAM@ECML) / Michael Przystupa (UBC) | Linear Algebra II: [[class slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/LinearAlgPresentation.ipynb)]; [[DLB CH02](https://www.deeplearningbook.org/contents/linear_algebra.html) ] |            |
...
| Mon Oct 1    |    Word meaning |  [[word_meaning_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/word_meaning.pdf)]; [[JM CH06: Vector Semantics](https://web.stanford.edu/~jurafsky/slp3/6.pdf)]|           |
| Wed Oct 3    |    Language Models | [[language_models_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/lang_models.pdf)]; [[PyTorch_Linear_Regression_Tutorial](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/LinearRegressionPytorchTutorial.ipynb)]; [[Theano_Linear_Regression_Tutorial](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/logistic_regression_theano.ipynb)]; [[JM CH03](https://web.stanford.edu/~jurafsky/slp3/3.pdf)]; [[A neural probabilistic language model](http://www.cs.ubc.ca/~amuham01/LING530/papers/bengio2003neural.pdf)] | hw01 due & hw02 out |
| Mon Oct 8    |    Thanksgiving Day – UBC closed  | NA  |            |
| Wed Oct 10    |   word vectors & Word2Vec   | [[word2vec_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/word2vec.pdf)]; [[Distributed representations of words and phrases and their compositionality](http://www.cs.ubc.ca/~amuham01/LING530/papers/mikolov2013distributed.pdf)]; [[Efficient estimation of word representations in vector space](http://www.cs.ubc.ca/~amuham01/LING530/papers/mikolov2013efficient.pdf)]; [[Linguistic regularities in continuous space word representations](http://www.cs.ubc.ca/~amuham01/LING530/papers/mikolov2013linguistic.pdf)] [[Enriching Word Vectors with Subword Information](http://www.cs.ubc.ca/~amuham01/LING530/papers/bojanowski2016enriching.pdf)] |     |
| Mon Oct 15    |      Feedforward Networks | [[feed_forward_nets_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/feedforward_nets.pdf)]; [[DLB CH06](https://www.deeplearningbook.org/contents/mlp.html)]   |          |
...
| Mon Oct 22   |     Recurrent Neural Networks I | [[RNN_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/RNN.pdf)]; [[DLB CH10](https://www.deeplearningbook.org/contents/rnn.html)]  | |        |
...
| Wed Nov 14    |    AI & Society / Guest Speaker Christine Wolf (IBM); Applications: Lexical Dialectology; Backprobagation I| [[backpropagation_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/backpropagation.pdf)]; [[Deep Models for Arabic Dialect Identification on Benchmarked Data](http://www.cs.ubc.ca/~amuham01/LING530/papers/elarabyDeepModels2018.pdf)]; [[A Neural Model for User Geolocation and Lexical Dialectology](http://www.cs.ubc.ca/~amuham01/LING530/papers/rahimiGeoloc2017.pdf)] |         |
| Mon Nov 19    | Backprobagation II; ConvNets  | [[backpropagation_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/backpropagation.pdf)]; [[ConvNet_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/CNNs.pdf)]; [[DLB CH09](https://www.deeplearningbook.org/contents/convnets.html)]  |
| Wed Nov 21    |  LSTMs & GRUs  |   |          |
