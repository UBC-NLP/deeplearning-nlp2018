...
| Mon Sept 24    |   Information Theory & Machine Learning Basics | [[info_theory_slides](https://github.com/UBC-NLP/deeplearning-nlp2018/blob/master/slides/information_theory.pdf)]; [[DLB CH05](https://www.deeplearningbook.org/contents/ml.html)]; [[KA: Calculus](https://www.youtube.com/watch?v=EKvHQc3QEow&list=PL19E79A0638C8D449); [3B1B Essence of Calculus](https://www.youtube.com/watch?v=WUvTyaaNkzM&list=PLZHQObOWTQDMsr9K-rj53DwVRMYO3t5Yr)] |         |
| Wed Sept 26    |    Word meaning; Feedforward Networks |  [[JM CH06: Vector Semantics](https://web.stanford.edu/~jurafsky/slp3/ed3book.pdf)]; [[DLB CH06](https://www.deeplearningbook.org/contents/mlp.html)] |           |
| Mon Oct 1    |    Language Models |  [[A neural probabilistic language model](http://www.cs.ubc.ca/~amuham01/LING530/papers/bengio2003neural.pdf)]; |           |
| Wed Oct 3    |    Word2Vec | [[Distributed representations of words and phrases and their compositionality](http://www.cs.ubc.ca/~amuham01/LING530/papers/mikolov2013distributed.pdf)] |
